...
**Data collection last run: 2025-08-08**
...
**Job dataset with 3,006,211 job announcements from Historical + Current APIs**
...
This provides 559MB of data that works with Python, R, or any Parquet-compatible tool.
...
Data collection last run: 2025-08-08. Early years are incomplete, mostly consisting of jobs with closing dates years after the opening dates. Note: Some job postings may have future opening dates. 
...
| 2024 | 367,753 | 352,296 |
| 2025 | 126,946 | 125,488 |
