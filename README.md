...
**Data collection last run: 2025-09-30**
...
**Job dataset with 3,055,133 job announcements from Historical + Current APIs**
...
This provides 729MB of data across all years (the repository itself is ~176MB without the parquet files, which are managed by Git LFS). Individual year files are typically 50-80MB and work with Python, R, or any Parquet-compatible tool.
...
Data collection last run: 2025-09-30. Early years are incomplete, mostly consisting of jobs with closing dates years after the opening dates. Note: Some job postings may have future opening dates. 
