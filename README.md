...
**Data collection last run: 2025-09-09**
...
**Job dataset with 3,028,393 job announcements from Historical + Current APIs**
...
This provides 670MB of data across all years (the repository itself is ~176MB without the parquet files, which are managed by Git LFS). Individual year files are typically 50-80MB and work with Python, R, or any Parquet-compatible tool.
...
Data collection last run: 2025-09-09. Early years are incomplete, mostly consisting of jobs with closing dates years after the opening dates. Note: Some job postings may have future opening dates. 
...
| 2024 | 367,758 | 352,296 |
| 2025 | 149,123 | 147,511 |
