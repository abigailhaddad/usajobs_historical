...
**Data collection last run: 2026-01-06**
...
**Job dataset with 3,114,597 job announcements from Historical + Current APIs**
...
Data collection last run: 2026-01-06. Early years are incomplete, mostly consisting of jobs with closing dates years after the opening dates. Note: Some job postings may have future opening dates. 
