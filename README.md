...
**Data collection last run: 2025-08-31**
...
**Job dataset with 3,022,941 job announcements from Historical + Current APIs**
...
Data collection last run: 2025-08-31. Early years are incomplete, mostly consisting of jobs with closing dates years after the opening dates. Note: Some job postings may have future opening dates. 
