...
**Data collection last run: 2025-09-04**
...
**Job dataset with 3,025,215 job announcements from Historical + Current APIs**
...
This provides 654MB of data that works with Python, R, or any Parquet-compatible tool.
...
Data collection last run: 2025-09-04. Early years are incomplete, mostly consisting of jobs with closing dates years after the opening dates. Note: Some job postings may have future opening dates. 
...
| 2024 | 367,756 | 352,296 |
| 2025 | 145,947 | 144,349 |
