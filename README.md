...
**Data collection last run: 2025-08-13**
...
**Job dataset with 3,009,455 job announcements from Historical + Current APIs**
...
This provides 575MB of data that works with Python, R, or any Parquet-compatible tool.
...
Data collection last run: 2025-08-13. Early years are incomplete, mostly consisting of jobs with closing dates years after the opening dates. Note: Some job postings may have future opening dates. 
