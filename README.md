...
**Job dataset with 3,007,734 job announcements from Historical + Current APIs**
...
This provides 469MB of data across all years (the repository itself is ~176MB without the parquet files, which are managed by Git LFS). Individual year files are typically 50-80MB and work with Python, R, or any Parquet-compatible tool.
