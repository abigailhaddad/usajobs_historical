...
**Data collection last run: 2025-08-01**
...
**Job dataset with 2,999,867 job announcements from Historical + Current APIs**
...
This provides 541MB of data that works with Python, R, or any Parquet-compatible tool.
...
Data collection last run: 2025-08-01. Early years are incomplete, mostly consisting of jobs with closing dates years after the opening dates. Note: Some job postings may have future opening dates. 
...
| 2024 | 367,752 | 352,296 |
| 2025 | 120,603 | 119,185 |
