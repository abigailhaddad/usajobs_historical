...
**Data collection last run: 2026-08-07**
...
Data collection last run: 2026-08-07. Coverage spans 2018-2026 with approximately 2.85M job postings. Early years (pre-2017) are incomplete, mostly consisting of jobs with closing dates years after the opening dates.
