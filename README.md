...
**Data collection last run: 2025-07-21**
...
**Job dataset with 2,986,968 job announcements from Historical + Current APIs**
...
This provides 493MB of data that works with Python, R, or any Parquet-compatible tool.
...
Data collection last run: 2025-07-21. Early years are incomplete, mostly consisting of jobs with closing dates years after the opening dates. Note: Some job postings may have future opening dates. 
...
| 2024 | 367,747 | 352,296 |
| 2025 | 107,709 | 106,430 |
