...
**Data collection last run: 2025-08-10**
...
**Job dataset with 3,007,120 job announcements from Historical + Current APIs**
...
Data collection last run: 2025-08-10. Early years are incomplete, mostly consisting of jobs with closing dates years after the opening dates. Note: Some job postings may have future opening dates. 
