...
**Data collection last run: 2025-07-30**
...
**Job dataset with 2,995,622 job announcements from Historical + Current APIs**
...
This provides 527MB of data that works with Python, R, or any Parquet-compatible tool.
...
Data collection last run: 2025-07-30. Early years are incomplete, mostly consisting of jobs with closing dates years after the opening dates. Note: Some job postings may have future opening dates. 
...
| 2024 | 367,751 | 352,296 |
| 2025 | 116,359 | 114,988 |
