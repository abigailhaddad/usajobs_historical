...
**Data collection last run: 2025-10-04**
...
**Job dataset with 3,059,514 job announcements from Historical + Current APIs**
...
Data collection last run: 2025-10-04. Early years are incomplete, mostly consisting of jobs with closing dates years after the opening dates. Note: Some job postings may have future opening dates. 
