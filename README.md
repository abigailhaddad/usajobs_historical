...
**Data collection last run: 2025-08-17**
...
**Job dataset with 3,012,354 job announcements from Historical + Current APIs**
...
This provides 589MB of data that works with Python, R, or any Parquet-compatible tool.
...
Data collection last run: 2025-08-17. Early years are incomplete, mostly consisting of jobs with closing dates years after the opening dates. Note: Some job postings may have future opening dates. 
...
| 2024 | 367,754 | 352,296 |
| 2025 | 133,088 | 131,556 |
